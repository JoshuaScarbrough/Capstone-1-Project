...
app.config['SQLALCHEMY_DATABASE_URI'] ="user=postgres.swovvcjjzcveduuikumr password=5918scarfootball8114 host=aws-0-us-east-2.pooler.supabase.comport=5432 dbname=postgres"
